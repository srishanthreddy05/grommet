...
export default function ItemsClient() {
  ...
  return (
    <main className="min-h-[calc(100vh-64px)] bg-gradient-to-br from-[#FFF9F0] via-[#FEF7EF] to-[#FDF5E6] px-6 sm:px-8 lg:px-12 py-10 sm:py-16">
      <div className="w-full">
        ...
        <div className="mb-[140px] max-w-2xl mx-auto">
